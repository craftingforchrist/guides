...
<Persona who="finn">
  A fair win feels better than an easy one.
</Persona>
...
Ask yourself one question: *does this mod let me do something the game wouldn't normally let me do, or see something it wouldn't normally let me see?*

* **No** — it's almost certainly fine. Nicer textures, a smoother framerate, a tidier HUD, a minimap on Survival.
...
These are approved for all our Minecraft servers:

* ✅ **Optifine** — performance and graphics options
* ✅ **CaffeineMC** (Sodium, Lithium and friends) — performance
* ✅ **ArmorStatusHUD / StatusEffectHUD** — shows your own armour and effects
* ✅ **LabyMod & 5zig** — all-in-one client mods
* ✅ **Toggle Sneak / Sprint** — comfort and accessibility
* ✅ **Lunar Client**
* ✅ **Badlion Client**
* ✅ **Cosmic Client**
* ✅ **PvPLounge Client**
* ✅ **Schematica / Litematica** — build planning and blueprints
* ✅ **Map mods, including ReplayMod**

:::info Why are the big clients allowed?

Lunar, Badlion, Cosmic and PvPLounge all bundle dozens of small mods together. We allow them because their default feature sets stay on the right side of the line. If you switch on a module inside one of them that does something from the prohibited list below, that's still a breach — the client being approved doesn't approve everything inside it.
...
* ❌ **Auto-hitters and autoclickers**
* ❌ **Aimbots** and any aim assistance
* ❌ **Fly mods**
...
* Scripts that craft, fish, farm or fight for you
* Wedging something into your keyboard or mouse to hold a button down while you're away

**What *is* fine:** holding a key down yourself, toggle sprint and toggle sneak, and anything the game does natively.

:::tip AFK and auto-fishing

Automating fishing or crop farming while you're away from the keyboard is the most common version of this we see. It's still automation, even though nothing is being clicked quickly.
...
The Mixed server is competitive, so several mods that are perfectly fine on Survival give too much of an edge there:

* ❌ Inventory sorters
* ❌ Mods that expose or enlarge player name-tags
...
If you've stumbled across a glitch in the game or one of our plugins, please don't quietly use it. Report it at [craftingforchrist.net/issues](https://craftingforchrist.net/issues) or raise a ticket on our [Discord](https://craftingforchrist.net/discord).

Reporting an exploit is genuinely appreciated, and it's never held against you.
